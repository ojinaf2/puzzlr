...
*/
export const GAMES = [
  { id: "wordle", name: "Wordle", tag: "Word guessing", accent: "#3aa76d", players: "1 player", daily: true, Comp: Wordle,
  ...
  { id: "hangman", name: "Hangman", tag: "Save the cowboy", accent: "#9c7a54", players: "1-6 players", daily: true, Comp: Hangman,
